...
2026年9月，我突发奇想想要穿越回十六年前重新使用拟物界面的 :ref:`mavericks` ，经过一番折腾，重新复活了这台十六年前的设备 :ref:`mavericks_mba11_late_2010` ，并最终通过 :ref:`alpine_install_mba11_late_2010` 获得了具备生产力的解决方案。

使用古早但设计制造精美的设备，关键是如何分配使用任务，扬长避短，充分发挥这台精巧机器的长处:

- 轻量级的开发工作，码字编程其实完全胜任，即使今天依然能够完成最现代的C,Python,Go,Ruby的开发工作
