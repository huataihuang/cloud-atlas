...
替换Jetson操作系统的TF卡，显然从头开始安装一次系统是非常不划算的，因为已经有太多调整和定制。所以，我最初尝试 :ref:`backup_restore_pi_by_tar` 相同的方案来重建和替换TF卡。但是，实践中发现NVIDIA Jetson采用 `U-Boot Customization <https://docs.nvidia.com/jetson/l4t/index.html#page/Tegra%20Linux%20Driver%20Package%20Development%20Guide/uboot_guide.html>`_ 作为bootloader，所以并未成功。
