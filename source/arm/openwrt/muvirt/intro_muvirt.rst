...
μVirt(muVirt) 是一个在OpenWrt上开发的微型虚拟化主机系统，用于提供主机简单的虚拟化网络功能，当前可以工作在64位ARM硬件设备，并且虚拟机兼容 :ref:`openwrt` 上开发的微型虚拟化主机系统，用于提供主机简单的虚拟化网络功能，当前可以工作在64位ARM硬件设备，并且虚拟机兼容 :ref:`linaro` VM系统规范(例如，VM镜像使用UEFI启动)。
