.. _mobile_cloud_arm_btrfs:

=========================
ARM移动云Btrfs
=========================

在 :ref:`apple_silicon_m1_pro` 的MacBook Pro 2022笔记本上，安装 :ref:`asahi_linux` ，存储文件系统采用 :ref:`btrfs` (内核版本升级到6.1之后无法采用 :ref:`mobile_cloud_x86_zfs` )
...
- 后续为 :ref:`mobile_cloud_arm_k8s` 提供 :ref:`btrfs_nfs` 实现容器间共享存储
