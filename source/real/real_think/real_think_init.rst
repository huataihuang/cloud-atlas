...
我最终在2021年10月买了一台二手 :ref:`hpe_dl360_gen9` 来替代我之前模拟部署云计算技术的 :ref:`mbp15_late_2013` ，目标是验证服务器领域相关技术，例如 :ref:`numa` 。
...
- :ref:`lfs` 则是我下一阶段的底层OS

  - 我期望构建一个自己掌控的完整操作系统，验证更为精细的内核裁剪和配置
  - 最小化底层操作系统，降低安全风险以及最大化发挥硬件性能

目前第一阶段，以 Ubuntu Linux 为基础构建，将在后续再实践 ``双操作系统启动`` 切换 :ref:`lfs` 实现完全定制系统
