...
只需要携带非常轻巧的 :ref:`chromecast` 以及便携蓝牙键盘 :ref:`ms_universal_foldable_kb` 和鼠标，就可以非常方便移动开发。当然如果周围不容易知道显示器，例如咖啡馆， :strike:`则可以购买一个廉价的15寸便携显示器(大约1k人民币)` 。汗，这样不是和携带笔记本没有差别了么？所以，我觉得还是直接使用手机屏幕，采用 :ref:`termux` 作为简单的Linux环境，能够远程登陆到服务器，使用 :ref:`vim`
进行开发，已经能够满足大多数工作场景。
