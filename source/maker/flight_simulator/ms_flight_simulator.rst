...
.. note::
   ...
   由于我现在计划通过 :ref:`amd_mi50_flash_vbios` 来运行 :ref:`hackintosh` ，这个软硬件组合堆栈有比微软模拟飞行更优化的 :ref:`x-plane` 模拟飞行器，更为逼真的气流与空气动力学物理引擎，所以我推迟在Windows平台模拟飞行，转为先尝试X-Plane。
...
- CPU/内存/GPU：i5-4460/R3 1200, 8GB, GTX 770/RX 570
- 存储/网络：150GB SSD, 5 Mbps

推荐配置:

- CPU/内存/GPU：i5-8400/R5 1500X, 16GB, GTX 970/RX 590
- 网络：20 Mbps

进阶建议:

- 流畅画质：建议 32GB 内存配搭 RTX 2070 Super/3060 以上显卡
- 外设：建议配备飞行摇杆或手柄以提升体验
