...
- 提供了基本的支付宝 ``支付码`` 功能，至少在很多超市购物可以畅通无阻 - 现代生活使用现金支付非常麻烦
  ...
  - 如果你有Apple Watch，那么已经具备了无需手机就可以通过智能手表的 ``支付宝智能设备离线支付`` 功能实现 ``扫码支付`` 功能，以及 ``扫码坐车`` 等功能
  - 实际上 Nokia 105 4G 也只是有限支持支付宝，只能实现 ``扫码支付`` 功能，和上述通过 Apple Watch 提供的支付宝功能是一样的，所以，如果你已经有Apple Watch，完全没有必要仅仅为了这个功能购买Nokia 105 4G手机(虽然这款手机非常便宜，只要200元)

- 虽然很多时候，我们还依赖地图导航、大众点评、共享单车，但是使用频率比电子支付要低不少，并且也是能够克服的(大多数也就是2点一线上下班，公共交通加两腿基本能够畅通无阻)

我考虑是否可以结合功能手机和Kindle来实现生活的 ``断舍离`` ，当然随身还是需要有一个智能手机备用，需要智能手机来弥补以下场景：
