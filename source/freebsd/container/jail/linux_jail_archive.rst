...
.. literalinclude:: linux_jail_archive/linux_enable
   :caption: 启动时启用Linux ABI

- 一旦配置了启动时启用Linux ABI，就可以立即用命令启用linux兼容，无需重启操作系统

.. literalinclude:: linux_jail_archive/linux_start
   :caption: 启动Linux兼容
...
.. literalinclude:: linux_jail_archive/d2l
...
.. literalinclude:: linux_jail_archive/start_j2l_first
...
.. literalinclude:: linux_jail_archive/start_j2l_first_jls
...
.. literalinclude:: linux_jail_archive/exec_d2l
   :caption: 通过 ``jexec`` 进入 ``d2l`` jail

- 完成后在host主机上停止 ``d2l`` :

 .. literalinclude:: linux_jail_archive/stop_d2l
    :caption: 停止 ``d2l`` jail

( ``我的步骤`` )直接Host执行 :ref:`debootstrap` 获取Linux
-------------------------------------------------------------

.. literalinclude:: linux_jail_archive/host_debootstrap
...
.. literalinclude:: linux_jail_archive/host_df
...
.. literalinclude:: linux_jail_archive/df
...
.. literalinclude:: linux_jail_archive/d2l_raw_sockets.conf
...
.. literalinclude:: linux_jail_archive/sysctl
   :caption: 在FreeBSD Jail中(还没有chroot) ``sysctl`` 检查 ``allow_raw_sockets``

输出显示:

.. literalinclude:: linux_jail_archive/sysctl_output
...
.. literalinclude:: linux_jail_archive/ifconfig
   :caption: Linux Jail无法使用 ``ifconfig``
   :emphasize-lines: 16,19-21,33

同样，由于没有socks支持，运行 :ref:`jupyter` :

.. literalinclude:: linux_jail_archive/juypter_socket_error
...
.. literalinclude:: linux_jail_archive/fix_home
