...
然而很不幸，我购买的 :ref:`dell_t5820` 遇到了非常诡异的无法启动的问题，排查了一个晚上，最后从卖家那里获知，售卖的T5820最高只支持 :ref:`xeon_w-2225` 。经过和gemini讨论和 :ref:`dell_t5820_crash_debug` 定位到主板 **电感不足** 导致无法支持高启动电流的处理器。
