.. _build_lineageos_21_pixel_4:

=======================================
为Pixel 4编译LineageOS 21(Android 14)
=======================================

.. note::

   2024年9月，发现LineageOS已经发布了支持Pixel 4的Android 14版本，比Google官方支持更进一步(官方只对Pixel 4a之后版本提供Android 14)，这重新触发了我的折腾的念头。将在原有 :ref:`build_lineageos_20_pixel_4` 基础上进行实践。本文待完成(在没有看到这段注释取消之前，表明实践尚未完成，则请勿参考本文)
