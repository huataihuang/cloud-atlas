...
举例: :ref:`gentoo_sway_chinese_input` 的 `gentoo package: app-i18n/fcitx <https://packages.gentoo.org/packages/app-i18n/fcitx>`_ 就提供了两个系列: 稳定版本 ``4.2.9.8`` 和 测试版本 ``5.1.5`` :
