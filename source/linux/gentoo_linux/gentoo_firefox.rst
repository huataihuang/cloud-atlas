...
浏览器的编译非常庞大，不过 Firefox 编译似乎比 :ref:`gentoo_chromium` 要轻很多，在我的 :ref:`mba13_early_2014` 上一个晚上就完成了编译(具体时间不详)，看起来我的 i5 处理器 8G 内存也能轻松完成
...
- 非常轻快，在 :ref:`mba13_early_2014` 启动迅速(默认没有使用插件)
