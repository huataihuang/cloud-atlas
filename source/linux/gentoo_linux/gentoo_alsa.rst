...
:ref:`alsa` 是声卡的Advanced Linux Sound Architecture。以下是我的 Gentoo Linux 实践，以完成类似之前在 :ref:`arch_linux` 平台完成的 :ref:`linux_audio` 配置部署。
...
- ``Open Sound System (OSS)`` 已经被 :ref:`alsa` 取代，所以我去除了 ``Preclaim OSS device numbers`` 配置
...
.. warning::
   ...
   还有很多有关 :ref:`alsa` 的配置，涉及多应用程序使用声卡设备等高级设置，我没有具体实践，待以后有机会再尝试。请参考官方原文
