.. _archlinux_zfs-dkms_arm:

=========================================
使用zfs-dkms在arch linux(ARM)编译安装ZFS
=========================================

.. note::

   本文实践是之前在 :ref:`apple_silicon_m1_pro` 笔记本上完成，所以现在我将这篇笔记重命名为ARM架构，以便和 :ref:`archlinux_zfs-dkms_x86` (在 :ref:`mba11_late_2010` 上)区分开
