...
.. warning::
   ...
   虽然我的实践是成功的，但是对于 :ref:`raspberry_pi_os` 我还是采用 :ref:`pi_disable_auto_resize` ，然后采用手工 :ref:`expend_ext4_rootfs_online` 实现指定容量扩展。这样扩展分区指定大小后无需计算文件系统扩展的大小，并且EXT4文件系统扩展比收缩难度和风险要低，更安全一些。
