...
虽然 :ref:`xfce` 相对轻量，但是随着功能逐渐丰富，其内存使用率已经逐渐追平GNOME和KDE(启动后内存占用700+MB)。对于 :ref:`pi_400` 这样硬件有限的平台，已经非常沉重。Kali Linux发行版提供的 :ref:`sway` 可以充分利用屏幕空间并且使用资源非常少，所以我改为 :ref:`run_sway`
