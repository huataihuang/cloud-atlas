...
参考 `Ubuntu kernel lifecycle and enablement stack <https://ubuntu.com/kernel/lifecycle>`_ 可以看到当前最主流的 24.04.4 LTS (HWE) 使用了 ``6.17`` 内核，可以通过如下方法安装:

.. literalinclude:: ubuntu_server/24.04.4_lts_hwe
   :caption: 安装 24.04.4 LTS(HWE)
